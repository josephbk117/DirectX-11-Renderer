...
#undef X
	...
	private:
		...
		// friend relationships are used liberally through out the DynamicConstant system
	...
	public:
		...
		// returns offset of leaf types for read/write purposes w/ type check in Debug
		template<typename T>
...
#undef X
	...
	private:
		...
		// sets all offsets for element and sub elements, prepending padding when necessary
	...
	// CookedLayout represent a completed and registered Layout shell object
	...
	private:
		// refs should only be constructible by other refs or by the buffer
